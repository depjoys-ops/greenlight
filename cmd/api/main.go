...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "fc890816d241bb", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "4163abef069a35", "SMTP password")
